...
16. The script will check If SQL Server Service account or SQL Agent account are running using Local Service, Local System or NT SERVICE, if yes, then the status column will be marked as REVIEW.
